...
line each event becomes in the language you read amenbo in, and the SMTP conversation that would
carry a message. A whole message — a subject, and a body of those lines — is not assembled yet,
